'use strict';
/* Lección 1 (Intro a la programación). Ejercicio 3. Modificar clases CSS desde JS */
const listElement = document.querySelector('.js-list');

const newFormElement = document.querySelector('.js-new-form');
newFormElement.classList.remove('collapsed');

/* Lección 1 (Intro a la programación). Ejercicio 4. Guarda la información en variables 
